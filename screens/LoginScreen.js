  ...
  return (
    <SafeAreaView  style={tailwind`bg-white flex-1`}>
        <View style={tailwind`my-25`}>
            ...
            <Text style={tailwind`text-center text-gray-500 text-sm my-5`}>Sign in to your account</Text>
                ...
                <View style={tailwind`w-[90%] mx-auto`}>
                        ...
                        {checkValidEmail ? (
                            ...
                            <View style={tailwind`w-[90%] p-3 px-5 bg-white mx-auto rounded-full shadow my-2 flex-row items-center gap-2`}>
                                ...
                                <TextInput placeholder='email' style={tailwind`text-xs flex-1 text-gray-500`} value={email} onChangeText={text => handelCheckEmail(text)}/>
                            </View>
                        )}
                        ...
                        {checkValidPassword ? (
                            <View style={tailwind`w-[90%] p-3 px-5 bg-white mx-auto border border-red-500 rounded-full shadow my-2 flex-row items-center gap-2`}>
                                ...
                                <TextInput placeholder='Password' style={tailwind`text-xs flex-1 text-red-500`} 
                                value={password}
                            ...
                            <View style={tailwind`w-[90%] p-3 px-5 bg-white mx-auto rounded-full shadow my-2 flex-row items-center gap-2`}>
                                ...
                                <TextInput placeholder='Password' style={tailwind`text-xs flex-1`} 
                                value={password}
                                onChangeText={text => handelCheckPassword(text)}
                                secureTextEntry={passwordSecure}/>
